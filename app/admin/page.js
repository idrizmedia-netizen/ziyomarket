      ...
      <div className="px-5 py-6 max-w-[1000px] mx-auto pb-16">
        {loading ? (
          ...
          <div className="text-center py-16 text-muted">
            Sizda admin huquqi yo&apos;q. Agar bu xato bo&apos;lsa, saytni sozlagan
            shaxsdan Firestore&apos;dagi <code>admins</code> to&apos;plamiga emailingizni
            qo&apos;shishini so&apos;rang.
          </div>
        ) : (
          <>
            ...
            {sales.length === 0 ? (
              <div className="text-muted text-sm">Hali sotuv bo&apos;lmagan.</div>
            ) : (
