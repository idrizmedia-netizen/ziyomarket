...
export async function placeOrder({ uid, buyerName, buyerEmail, items, pickupTime, note }) {
...
export async function submitSellerApplication({ uid, name, email, phone, message }) {
...
export async function addSeller(email, name, addedByEmail) {
